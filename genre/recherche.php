				...
				<article>
					...
					<table border=1>
						...
						<?php
							...
							// Récupérer le film à rechercher
							...
							$req= "SELECT film.id_images, film.nom_film, prix.prix
										  ...
										  WHERE film.nom_film LIKE '%$recherche%' LIMIT $premier_element, $elements_par_page ";
							...
							{
								echo '<h2>Pas de resultat disponibles à votre recherche</h2>';
							}
							else
							{
