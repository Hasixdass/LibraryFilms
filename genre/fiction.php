				...
				<article>
					...
					<table border=1>
						...
						<?php
							...
							// Requête pour récupérer les films de la catégorie 'Science-Fiction' avec pagination
							$req="SELECT film.id_images, film.nom_film, prix.prix
										...
										WHERE genre.nom_genre = 'Science-Fiction' LIMIT $premier_element, $elements_par_page ";
